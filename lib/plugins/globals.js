...
/*  this.sandbox.Array = Array;
  ...
  this.sandbox.Date = Object.freeze(Date);
//  function() {return Object.create(Date.apply(arguments))};
//  this.sandbox.Date.__proto__.constructor = Date.__proto__.constructor
